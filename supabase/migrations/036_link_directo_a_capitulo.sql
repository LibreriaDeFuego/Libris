-- Libris — migración 036: profile_activity y recent_activity ahora también
-- traen chapter_id.
--
-- Al compartir un comentario/nota de voz de un capítulo, la tarjeta en
-- Inicio/Perfil ("Ver el resto de los comentarios en el club") llevaba
-- siempre a la pantalla general de Comentarios (todo el libro, selector de
-- capítulos completo) en vez de abrir directo en el capítulo del que se
-- trata. Sin chapter_id en estas dos funciones, ActivityCard no tenía cómo
-- armar el link con ?capitulo=<id> que ya usa ChapterPath.
