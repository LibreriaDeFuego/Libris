...
- **La portada, más grande** — se probó una versión con la portada ocupando toda la franja izquierda de la tarjeta (de punta a punta); no era lo que hacía falta, se volvió atrás. Lo que se pidió es agrandar la misma miniatura de siempre, nada más: `COVER_W`/`COVER_H` pasaron de 56×76 a 84×114 (mismo 0.737 de proporción, escalado 1.5×), con la sombra apilada en diagonal y el resto del layout intactos.
